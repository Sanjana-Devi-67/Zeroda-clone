    ...
    return ( 
        <div className="container">
            <div className='row p-5 mt-5 mb-5'>
                ...
                <div className='col-4 p-5 mt-5 '>
                    <h4  className="mb-5"><i class="fa fa-user" aria-hidden="true"></i> Your Zerodha Account</h4>
                     ...
                     <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>DP IDand bank details</a><br/>
                ...
                <div className='col-4 p-5 mt-5'>
                    <h4  className="mb-5"><i class="fa fa-bar-chart" aria-hidden="true"></i> Kite</h4>
                     <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>MarginBeverage, Product and Order types</a><br/>
                     <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Kite Web and Mobile</a><br/>
                     <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Trading FAQ's</a><br/>
                ...
                <div className='col-4 p-5 mt-5'>
                    <h4  className="mb-5"><i class="fa fa-address-book-o" aria-hidden="true"></i> Funds</h4>
                ...
                <div className='col-4 p-5 mt-5'>
                    <h4  className="mb-5"><i class="fa fa-circle-o" aria-hidden="true"></i> Coin</h4>
                     ...
                     <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Governmnet Securities</a>
                </div>
            </div>
        </div>
     );
